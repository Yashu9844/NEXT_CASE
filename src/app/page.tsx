 ...
 <p><span className="font-semibold">1,500</span> happy customers </p>
             ...
             <div className="col-span-full lg:col-span-1 w-full flex justify-center px-8 sm:px-16 md:px-0 mt-32 lg:mx-0 lg:mt-20 h-fit">
              <div className="relative md:max-w-xl">
                <img className="absolute lg:w-52 left-56 -top-20 select-none hidden sm:block lg:hidden xl:block" src="/your-image.png" alt="image" />
                <img  className="absolute w-20 -left-6 -bottom-6 select-none" src="/line.png" alt="image" />
