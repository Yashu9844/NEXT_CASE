  ...
  return (
   <ol className="rounded-md bg-white lg:flex lg:rounded-none lg:border-l lg:border-r lg:border-gray-200">
    {STEPS.map((step,i)=>{
        ...
        const isComplete = STEPS.slice(i+1).some((step)=>pathname.endsWith(step.url))
                ...
                />
                    ...
                    <span className={cn(i !== 0  ? 'lg:pl-9' : '', 'flex items-center px-6 py-4 text-sm font-medium')}>
                       <span className="flex shrink-0">
                        <img src={imgPath} alt="image"  className={cn('flex h-20 w-20 object-contain items-center justify-center ',{
